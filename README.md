...
The new version ll be much more faster and over all "build properly", with seperate threats per module(script), by built over Rust which is a compile language and
